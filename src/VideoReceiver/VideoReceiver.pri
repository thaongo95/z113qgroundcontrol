...
LinuxBuild {
    ...
    contains(ANDROID_TARGET_ARCH, armeabi-v7a) {
        GST_ROOT = /home/b6/siyiqgroundcontrol/gstreamer-1.0-android-universal-1.18.6/armv7
    } else:contains(ANDROID_TARGET_ARCH, arm64-v8a) {
        GST_ROOT = /home/b6/siyiqgroundcontrol/gstreamer-1.0-android-universal-1.18.6/arm64
    } else:contains(ANDROID_TARGET_ARCH, x86_64) {
        GST_ROOT = /home/b6/siyiqgroundcontrol/gstreamer-1.0-android-universal-1.18.6/x86_64
    } else {
        message(Unknown ANDROID_TARGET_ARCH $$ANDROID_TARGET_ARCH)
        GST_ROOT = /home/b6/siyiqgroundcontrol/gstreamer-1.0-android-universal-1.18.6/x86
    }
    exists($$GST_ROOT) {
